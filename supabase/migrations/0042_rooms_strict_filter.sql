-- search_profiles.rooms_strict: wenn true, matched die RPC nur exakt rooms
-- (kein ±1). Default false → Bestand bleibt unverändert.
-- Sophie setzt rooms_strict=true bei "genau N", "nur N", "exakt N" etc.

alter table search_profiles
  add column if not exists rooms_strict boolean default false;
