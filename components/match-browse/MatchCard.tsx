          ...
          <div className="absolute bottom-0 inset-x-0 p-4 pb-3 bg-gradient-to-t from-black/85 via-black/40 to-transparent text-white">
            <div className="flex items-end justify-between gap-3">
              <div className="min-w-0">
                ...
                {/* "{n} ähnliche Inserate"-Hint. Backend zählt jetzt nur
                    Cluster-Member mit identischem city+district+type+rooms,
                    Stockfoto-False-Positives fallen so weg. Klick → Detail-
                    Page mit Liste der ähnlichen, sortiert nach Preis. */}
