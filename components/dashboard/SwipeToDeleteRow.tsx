...
export function SwipeToDeleteRow({ endpoint, what, children }: Props) {
  ...
  // Klick außerhalb schließt offene Zeile
  React.useEffect(() => {
    if (!open) return;
  ...
  // Verhindert, dass ein "Drag-Klick" die Detail-Navigation auslöst.
      ...
      <div className="absolute inset-y-0 right-0 flex items-stretch">
        {confirming ? (
          <button
            ...
            onClick={doDelete}
            disabled={submitting}
            className="flex w-[168px] items-center justify-center gap-1.5 bg-red-700 text-sm font-medium text-white px-3 disabled:opacity-70"
          ...
          <button
            ...
            className="flex w-[80px] items-center justify-center bg-red-600 text-white"
